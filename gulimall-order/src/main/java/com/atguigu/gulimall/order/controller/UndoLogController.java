...
import com.atguigu.gulimall.order.dto.UndoLogDTO;
import com.atguigu.gulimall.order.excel.UndoLogExcel;
...
public class UndoLogController {
    ...
    @GetMapping("page")
    //@RequiresPermissions("order:undolog:page")
    ...
    @GetMapping("export")
    @LogOperation("导出")
    //@RequiresPermissions("order:undolog:export")
